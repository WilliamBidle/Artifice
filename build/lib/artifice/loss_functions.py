...
class MeanAbsoluteError(LossFunction):
    ...
    def __init__(self):
        ...
        self.expression = Abs(self.y_pred - self.y_true)
...
class MeanAbsolutePercentError(LossFunction):
    ...
    def __init__(self):
        ...
        self.expression = 100 * Abs((self.y_pred - self.y_true) / (self.y_true))
...
class MeanLogSquaredError(LossFunction):
    ...
    def __init__(self):
        ...
        self.expression = (log(self.y_pred + 1.) - log(self.y_true + 1.))**2
...
class BinaryCrossEntropy(LossFunction):
    ...
    def __init__(self):
        ...
        self.expression = -(self.y_true*log(self.y_pred) + (1 - self.y_true)*log(1 - self.y_pred))
...
class PoissonError(LossFunction):
    ...
    def __init__(self):
        ...
        self.expression = self.y_pred - self.y_true * log(self.y_pred)